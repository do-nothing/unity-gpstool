...
public class Denglinggu_office_coreArea : TriggerLogic
{
    public Denglinggu_office_coreArea(Vector3 position, float radius)
    ...
    protected override void onVisitorIn()
    {
        ...
        voices.AddLast("play:Voice/office/核心区域测试点");
