...
namespace Microwise.Guide
{
    public class TriggersSetting
    {
        ...
        static TriggersSetting()
        {
            ...
            /********************** 李军 Start *************************/
            triggers.Add(new Denglinggu_park_origin(new Vector3(0, 0, 0), 3)); // 进入点（喷泉）
            triggers.Add(new Denglinggu_park_entrance(new Vector3(0, 0, 18), 3)); // 瞪羚谷入口
            triggers.Add(new Denglinggu_park_intersection1(new Vector3(0, 0, 43), 5)); //岔路口1
            ...
            triggers.Add(new Denglinggu_park_warning2(new Vector3(-14, 0, 84), 2)); //道路施工
            triggers.Add(new Denglinggu_park_intersection3(new Vector3(-31.5f, 0, 104), 3)); //岔路口3
            triggers.Add(new Denglinggu_park_warning3(new Vector3(-34, 0, 142), 10)); //时间提醒
            triggers.Add(new Denglinggu_park_recommend(new Vector3(0, 0, -20), 10)); //推荐晚饭
            triggers.Add(new Denglinggu_park_report(new Vector3(0, 0, -40), 10)); //客户行为分析语音
